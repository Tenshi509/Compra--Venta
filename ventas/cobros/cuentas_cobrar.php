...
$cuentascobrar = consultas::get_datos("SELECT * FROM v_cuentascobrar WHERE estado = 'PENDIENTE' ORDER BY factura_completa DESC");
?>
            ...
            <?php if (!empty($apertura)) { ?>
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Cuentas a cobrar Pendientes</h3>
                  <div class="box-tools">
                    <a href="cuentas_cobrar_todos.php" class="btn btn-primary text-bold">Ver Todos</a> 
                  </div>
                </div>
