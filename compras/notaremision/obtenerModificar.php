...
<div class="form-group">
    <input type="hidden" name="vmateriaprima" value="<?php echo $materiaprima[0]['id_materiaprima']; ?>">
    <label>Materia Prima</label>
    <select class="form-control" style="width: 100%;"disabled>
        <option value=""><?php echo $materiaprima[0]['descripcion']; ?></option>
    </select>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="number" class="form-control" value="<?php echo $remision[0]['cantidad'] ?>" readonly>
</div>

<div class="form-group">
    <label>Nuevo</label>
    <input type="number" class="form-control" name="vcantidad" value="<?php echo $remision[0]['cantidad'] ?>" required onKeyDown="if(this.value.length==10 && event.keyCode!=8) return false;" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
</div>
