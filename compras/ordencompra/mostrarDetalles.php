...
$detalle = consultas::get_datos("SELECT * FROM v_presupuestoproveedor_det WHERE id_presupuestoproveedor = $id_presupuesto");
$liquidacion = consultas::get_datos("SELECT SUM(iva10) AS diez, SUM(iva5) AS cinco  FROM v_iva_presupuestoproveedor WHERE id_presupuestoproveedor = $id_presupuesto");
$presupuestoproveedor = consultas::get_datos("SELECT * FROM v_presupuestoproveedor WHERE id_presupuestoproveedor =  $id_presupuesto");
