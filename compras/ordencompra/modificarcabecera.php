                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                                ...
                                <h3 class="box-title">Modificar Orden de Compra</h3>
                            </div>
                            <!--- FIN HEADER --->
                                ...
                                <div class="box-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <label>Codigo</label>
                                            <input type="text" class="form-control" value="<?php echo $ordencompra[0]['id_ordencompra'] ?>" readonly name="vidordencompra">
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" rows="3" name="vobservacion"><?php echo $ordencompra[0]['observacion'] ?></textarea>
                                            </div>
                                        </div>
...
<script>
    function asociarPresupuesto() {
        $(document).ready(function() {
            $("#proveedor option:selected").each(function() {
                codigo = $(this).val();
                $.post("cargarPresupuestoModificar.php?vidpresupuestoproveedor=<?php echo $codigopresupuesto ?>", {
                    codigo: codigo
                }, function(data) {
    ...
    window.onload = asociarPresupuesto();
</script>
