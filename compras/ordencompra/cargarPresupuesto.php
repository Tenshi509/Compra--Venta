...
$presupuestoproveedor = consultas::get_datos("SELECT * FROM v_presupuestoproveedor WHERE id_proveedor =  $cod AND estado = 'CONFIRMADO' ORDER BY id_presupuestoproveedor ASC");
...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <select class="form-control select2" name="vpresupuestoproveedor" id="cbx_presupuesto">
