...
$ultimocodigo = consultas::get_datos("SELECT COALESCE(MAX(id_presupuestoproveedor),0)+1 AS ultimo FROM presupuestoproveedor");
$proveedor = consultas::get_datos("SELECT * FROM v_proveedor WHERE estado = 'ACTIVO' ORDER BY id_proveedor ASC");

$pedidocompra = consultas::get_datos("SELECT * FROM v_pedidoscompras WHERE estado = 'CONFIRMADO' ORDER BY id_pedidocompra ASC");
                            ...
                            <form action="control.php" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <label>Fecha</label>
                                            <input type="date" class="form-control" name="vfecha" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Presupuesto N°</label>
                                            <input type="text" class="form-control" name="vnropresupuesto" required onKeyDown="if(this.value.length==20 && event.keyCode!=8) return false;" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Validez (Días)</label>
                                            <input type="number" class="form-control" name="vvalidez" required onKeyDown="if(this.value.length==4 && event.keyCode!=8) return false;" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control select2" name="vpedido" required id="cbx_pedido">
                                                <?php if (!empty($pedidocompra)) { ?>
                                                    <option value="" disabled selected>Seleccione una opción</option>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <option value="">No existe ningun pedido</option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
