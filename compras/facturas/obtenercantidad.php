...
<div class="form-group col-xs-6">
    ...
    <input type="number" class="form-control" value="<?php echo $cantidad[0]['cantidad'] ?>" readonly>
</div>
<div class="form-group col-xs-6">
    <label>Nuevo</label>
...
<div class="form-group col-xs-12">
    ...
    <input type="number" class="form-control" min="1" value="<?php echo $cantidad[0]['precio_unitario'] ?>" id="precio_modificar" name="vpreciounitario" required onKeyDown="if(this.value.length==15 && event.keyCode!=8) return false;" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" onchange="calcularmontomodificar()" onclick="calcularmontomodificar()" onkeyup="calcularmontomodificar()">
</div>
<div class="form-group col-xs-12">
    <label>Total</label>
